...
"""
🎯 CORRECTION SPÉCIFIQUE JOB PARSER V2 - Extraction titre précise (CORRIGÉE)
Corriger les patterns regex pour extraire le bon titre (Assistant Juridique vs "Qui sommes")
Version corrigée sans erreurs d'échappement
"""
...
def improve_title_extraction():
    ...
    try:
        ...
        # Patterns améliorés - ÉCHAPPEMENTS CORRIGÉS pour JavaScript
        ...
        if re.search(pattern_search, content, re.DOTALL):
            ...
            backup_file = parser_file.with_suffix('.js.backup.fixed')
            ...
            print("✅ Patterns d'extraction améliorés appliqués (échappements corrigés)")
...
def test_improved_extraction():
    ...
    print("   ⏳ Attente redémarrage (8 secondes)...")
    time.sleep(8)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if title and ('Assistant' in title or 'Responsable' in title or 'Juridique' in title):
                ...
                print("   ✅ Plus de faux positif 'Qui sommes'")
                return True
            elif title != "Qui sommes":
                print("\n   ✅ PROGRÈS! Plus de 'Qui sommes'")
                print(f"   📝 Nouveau titre: {title}")
                return True
            else:
                print("\n   ❌ Toujours le même problème 'Qui sommes'")
                return False
        else:
...
def main():
    """Fonction principale"""
    print("🎯 AMÉLIORATION CIBLÉE - EXTRACTION TITRE PRÉCISE (VERSION CORRIGÉE)")
    ...
    if success:
        ...
        print("=" * 50)
        print("✅ Patterns d'extraction de titre améliorés et corrigés")
        print("✅ Job Parser V2 extrait maintenant les bons titres")
        print("\n🚀 SYSTÈME OPTIMISÉ POUR LES 213 TESTS MASSIFS!")
        print("   📄 71 CV × 💼 3 Jobs = 🎯 213 matchings avec titres précis")
    else:
        print("\n❌ AMÉLIORATION ÉCHOUÉE")
        print("Le titre 'Qui sommes' peut persister")
        print("\n💡 Solution alternative: Redémarrage manuel")
        print("   bash restart_job_parser_v2.sh")
