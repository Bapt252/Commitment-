"""
Worker RQ pour le service de parsing de fiches de poste.
...
setup_logging()
logger = logging.getLogger("job-parser-worker")
...
def run_worker():
    ...
    queue_names = ['job_parsing_premium', 'job_parsing_standard', 'job_parsing_batch']
