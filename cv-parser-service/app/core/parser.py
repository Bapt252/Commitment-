...
def extract_text_from_pdf(file_path):
    ...
    try:
        ...
        current_app.logger.error(f"Erreur lors de l'extraction du texte du PDF: {e}", exc_info=True)
    return text
...
def extract_text_from_docx(file_path):
    ...
    try:
        ...
        current_app.logger.error(f"Erreur lors de l'extraction du texte du DOCX: {e}", exc_info=True)
        return ""
...
def extract_text_from_doc(file_path):
    ...
    try:
        ...
        current_app.logger.error(f"Erreur lors de l'extraction du texte du DOC: {e}", exc_info=True)
        return ""
...
def parse_cv_with_gpt(file_content, file_type):
    ...
    try:
        ...
        current_app.logger.error(f"Erreur lors de l'analyse du CV: {e}", exc_info=True)
...
def chat_with_cv_data(message, history, document_data):
    ...
    try:
        ...
        current_app.logger.error(f"Erreur lors de la discussion avec l'IA: {e}", exc_info=True)
        return {
