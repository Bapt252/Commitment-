...
# Script pour reconstruire et redémarrer le service job-parser avec les corrections
...
log_info "Début de la reconstruction du service job-parser avec les corrections..."
